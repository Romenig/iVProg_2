...
public class IlmBaseGUI extends BaseGUI {
	...
	protected void setNewAssignmentButton() {
		newAssBtn = makeButton("newassignment", ResourceBundleIVP.getString("newAssBtn.AltText"), ResourceBundleIVP.getString("newAssBtn.AltText"), ResourceBundleIVP.getString("newAssBtn.AltText"));
