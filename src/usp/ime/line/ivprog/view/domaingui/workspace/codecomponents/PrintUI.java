...
public class PrintUI extends CodeBaseUI {
	...
	private void addComponents() {
		...
		String printableExpression = ((IVPPrinter) Services.getService().getModelMapping().get(getModelID())).getPrintableID();
		initialExpression = (VariableSelectorUI) Services.getService().getRenderer().paint(printableExpression, scopeModelID);
