package usp.ime.line.ivprog.view.workspace.variable;
...
public class IVPVariableBasic extends RoundedJPanel {
    ...
    private JCustomTextField name;
    private JCustomTextField value;
    ...
    private void initValueContainer() {
        value = new JCustomTextField();
        value.setCurrentPattern(JCustomTextField.PATTERN_VARIABLE_VALUE_INTEGER);
        value.setValue("1");
    ...
    private void initName() {
        ...
        name.setCurrentPattern(JCustomTextField.PATTERN_VARIABLE_NAME);
        add(name);
    }
    ...
    private void changeVariableType() {
        if (variable != null) {
            if (variable.getVariableType() == Expression.EXPRESSION_INTEGER) {
                ...
                value.setVisible(true);
                value.setCurrentPattern(JCustomTextField.PATTERN_VARIABLE_VALUE_DOUBLE);
                value.setValue("1.0");
                booleanValue.setVisible(false);
            } else if (variable.getVariableType() == Expression.EXPRESSION_STRING) {
                value.setVisible(true);
                value.setCurrentPattern(JCustomTextField.PATTERN_VARIABLE_VALUE_STRING);
