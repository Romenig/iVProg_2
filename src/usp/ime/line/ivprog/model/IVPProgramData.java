...
public class IVPProgramData extends DomainObject {
	...
	/**
	 * @param operationListeners
	 *            the operationListeners to set
	 */
	...
	/**
	 * @param expressionListeners
	 *            the expressionListeners to set
	 */
	...
	/**
	 * @param variableListeners
	 *            the variableListeners to set
	 */
	 ...
	 * @param operationUI
	 */
	public void addOperationListener(OperationUI operationUI) {
		this.operationListeners.add(operationUI);
	}
